...
const DATA = [
  {
    ...
    originalPrice: '15$',
    discount: '-20%',
    image: require('../bener/image3.png'),
    rating: 5,
  },
  {
    id: 'sale2',
    ...
    originalPrice: '22$',
    discount: '-15%',
    image: require('../bener/image2.png'),
    rating: 4,
  },
  {
    id: 'sale3',
...

  {
    ...
    originalPrice: '22$',
    discount: '-15%',
    image: require('../bener/image4.png'),
    rating: 4,
  },
  {
    id: 'new2',
...
const Shop = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Image
        source={require('../bener/shop_banner.png')} // Replace with actual image URL
