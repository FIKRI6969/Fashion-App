...
const HomeMain = ({ navigation }) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ImageBackground source={require('../bener/main1.png')} style={styles.image}>
      ...
      <View style={styles.row}>
        <View style={styles.column}>
          ...
          <ImageBackground source={require('../bener/main3.png')} style={styles.imageSmall}>
            <Text style={styles.imageText}>Black</Text>
          </ImageBackground>
        </View>
        <View style={styles.column}>
          <ImageBackground source={require('../bener/main2.png')} style={styles.imageMan}>
