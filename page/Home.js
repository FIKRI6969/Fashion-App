  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Image source={require('../bener/big_banner.png')} style={styles.image} />
      ...
      <View style={styles.newSection}>
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={styles.newItems}>
          <View style={styles.newItem}>
            <Image source={require('../produk/product1.png')} style={styles.newItemImage} />
            <Text style={styles.newLabel}>NEW</Text>
          </View>
          <View style={styles.newItem}>
            <Image source={require('../produk/product2.png')} style={styles.newItemImage} />
            <Text style={styles.newLabel}>NEW</Text>
          </View>
          <View style={styles.newItem}>
            <Image source={require('../produk/product3.png')} style={styles.newItemImage} />
            <Text style={styles.newLabel}>NEW</Text>
          </View>
        </ScrollView>
      </View>
